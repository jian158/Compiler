...
static const yytype_int16 yypact[] =
{
    ...
    -107,    50,    10,   236,   254,    35,  -107,  -107,  -107,  -107,
    -107,    60,   254,   254,   254,    58,    61,  -107,  -107,  -107,
      79,    66,    68,   316,    80,  -107,    81,    72,   254,    73,
      78,   112,    90,    30,   -12,    76,  -107,  -107,   147,    51,
     366,  -107,  -107,    86,    82,    81,   -12,  -107,   254,   254,
     254,   254,   254,   254,   254,   254,   104,   254,   254,   107,
    -107,   109,    76,  -107,   254,  -107,  -107,    82,  -107,  -107,
     182,   113,    97,  -107,   328,    99,  -107,  -107,  -107,   254,
    -107,  -107,  -107,   181,   147,   147,    51,    51,   450,   438,
    -107,   340,   426,   103,  -107,   105,  -107,   116,   110,   254,
    -107,   353,   119,   254,   111,    10,   154,  -107,  -107,   115,
     154,  -107,    53,   123,   200,   117,   121,   122,   254,   120,
    -107,   154,  -107,    20,  -107,  -107,  -107,   136,  -107,  -107,
    -107,   126,   254,  -107,  -107,   280,   254,   254,   254,  -107,
    -107,   132,   151,  -107,  -107,  -107,  -107,   378,   292,   390,
     254,   133,  -107,  -107,   139,   254,   142,   402,   154,   154,
     304,   154,   144,   131,   145,   254,   150,   154,  -107,  -107,
...
static const yytype_uint8 yydefact[] =
{
      ...
      55,    56,    44,    62,    57,    58,    63,    64,    60,    61,
      77,     0,    59,    83,    42,     0,    85,    49,     0,     0,
...
static const yytype_int16 yypgoto[] =
{
    -107,  -107,   185,  -107,     9,  -107,  -107,    49,    -2,  -106,
      45,  -107,  -107,  -107,  -107,  -107,  -107,  -107,    -3,    -4,
    -107,   108,    70,   -32,  -107,   -49,   -18,    84,    77,    -6
};
...
static const yytype_int16 yytable[] =
{
     ...
     106,   107,   108,   109,    81,   111,   112,    27,   101,    97,
      ...
      23,    24,    25,    29,   102,    18,    14,   121,    53,    14,
      18,    48,   183,   184,    61,   186,    97,    62,   116,    76,
     -75,   192,    13,    77,    27,    63,    67,    94,    54,   196,
      55,    94,    90,   -75,    66,    64,    83,    56,    57,    32,
      78,    54,   155,    82,    91,    33,    34,    80,    85,    79,
      56,    57,    84,    35,    36,    37,    38,   116,    99,    39,
     110,    40,    41,   113,   167,   168,   169,   114,   118,   117,
     120,    91,   -75,   123,    42,   125,   124,   163,   177,   -76,
      54,   153,    84,   180,   126,   130,   150,   156,    50,    56,
      57,   157,   158,   190,   164,   159,   173,   132,    12,   133,
      13,   165,   170,   171,   134,   135,   188,   178,   136,   137,
      90,    72,    73,   179,    91,    76,   181,    32,   187,    77,
     189,   152,   195,    33,    34,   191,   160,   194,   197,     7,
     115,    35,    36,    37,    38,   131,   127,    39,   -89,    40,
      41,     0,   -75,    70,    71,    72,    73,   129,     0,    76,
...
static const yytype_int16 yycheck[] =
{
      ...
      11,    12,    32,    35,    68,    16,    16,    99,    33,    16,
      21,    22,   178,   179,    16,   181,    82,    16,    84,    28,
      20,   187,     6,    32,    90,     6,    18,   119,    28,   195,
      30,   123,    16,    20,    28,    16,    18,    37,    38,    23,
      20,    28,   134,    30,    55,    29,    30,    35,    18,    28,
      37,    38,    30,    37,    38,    39,    40,   123,    32,    43,
      16,    45,    46,    16,   156,   157,   158,    18,    31,    16,
      31,    82,    20,    30,   138,    19,    31,   143,   170,    20,
      28,    18,    30,   175,    34,    34,    31,    30,   152,    37,
      38,    30,    30,   185,    18,    35,   162,     3,     4,     5,
       6,    35,    30,    12,    10,    11,    35,    34,    14,    15,
      16,    24,    25,    34,   125,    28,    34,    23,    34,    32,
      35,   132,    34,    29,    30,    35,   141,    35,    35,     4,
      82,    37,    38,    39,    40,   125,   119,    43,    16,    45,
      46,    -1,    20,    22,    23,    24,    25,   123,    -1,    28,
...
#line 48 "sytax.y" /* yacc.c:1646  */
    {(yyval.node)=newNode("Class",2,(yyvsp[-3].node),(yyvsp[-1].node));adjustNodes((yyval.node),1);}
#line 1579 "sytax.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 49 "sytax.y" /* yacc.c:1646  */
    {(yyval.node)=newNode("ExtClass",4,(yyvsp[-5].node),(yyvsp[-4].node),(yyvsp[-3].node),(yyvsp[-1].node));adjustNodes((yyval.node),3);}
...
#line 60 "sytax.y" /* yacc.c:1646  */
    {(yyval.node)=newNode("Fun:STATIC",4,(yyvsp[-7].node),(yyvsp[-6].node),(yyvsp[-4].node),(yyvsp[-1].node));}
...
#line 63 "sytax.y" /* yacc.c:1646  */
    { (yyval.node)=newNode("VarType",1,(yyvsp[0].node));adjustNodes((yyval.node),0);(yyval.node)->string_value=new string(*(yyvsp[-1].node)->string_value);}
...
#line 107 "sytax.y" /* yacc.c:1646  */
    {(yyval.node)=newNode("DeclareStm:STATIC",2,(yyvsp[-2].node),(yyvsp[-1].node));adjustNodes((yyval.node),1);}
#line 1791 "sytax.tab.c" /* yacc.c:1646  */
    break;

  case 41:
#line 108 "sytax.y" /* yacc.c:1646  */
    {(yyval.node)=newNode("DeclareStm:FINAL",2,(yyvsp[-2].node),(yyvsp[-1].node));adjustNodes((yyval.node),1);}
#line 1797 "sytax.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 109 "sytax.y" /* yacc.c:1646  */
    {(yyval.node)=newNode("DeclareStm:STATIC:FINAL",2,(yyvsp[-2].node),(yyvsp[-1].node));adjustNodes((yyval.node),1);}
